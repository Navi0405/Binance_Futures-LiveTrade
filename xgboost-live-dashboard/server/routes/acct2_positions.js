...
async function acct2_position_data() {
  try {
...
router.get('/', async (req, res) => {
  try {
    // Call the acct2_position_data function to get the data
    const openPositions = await acct2_position_data();
...
module.exports.acct2_position_data = acct2_position_data; // For standalone function
