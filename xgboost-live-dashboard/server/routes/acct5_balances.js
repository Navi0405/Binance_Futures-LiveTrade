...
const acctX5_key = process.env.acctX5_key;
const acctX5_secret = process.env.acctX5_secret;

// Helper function to sign a query
function signQuery(query) {
  return crypto.createHmac('sha256', acctX5_secret).update(query).digest('hex');
}
